...
final public class WalleyCheckoutView: UIView {
    ...
    private func setup() {
        ...
        webView.customUserAgent = "\(currentUserAgent) WalleyPaySDK/1.1 iOS/\(UIDevice.current.systemVersion)/\(UIDevice.current.model ?? "")"
    ...
    public func loadCheckout(publicToken: String, actionColor: String? = nil, language: String? = nil, actionTextColor: String? = nil, padding: String? = nil, containerId: String? = nil, baseURL: URL? = nil) {
        ...
        self.webView.loadHTMLString(stringToLoad, baseURL: baseURL)
    }
